...
const Cart = () => {
  ...
  if (products.length === 0) {
    return <p>Loading products...</p>;  // Prevent rendering when products are empty
  }
    ...
    <div className="border-t pt-14">
      ...
      <div>
        {cartData.map((item, index) => {
          // Ensure productData exists before accessing properties
          const productData = products.find((product) => product._id === item._id);
          if (!productData) return null; // Prevents errors on refresh
